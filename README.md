[![Build Status](https://dev.azure.com/tarmopajusaar/Test/_apis/build/status/gtarmo.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/tarmopajusaar/Test/_build/latest?definitionId=1&branchName=master)
